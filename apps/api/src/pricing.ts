...
export const MODEL_CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    priority: 20,
    upstreamModel: 'doubao-seed-2-0-mini-260428',
    displayName: '豆包 Mini',
    tools: 1,
    vision: 1,
    fallback: 'deepseek-chat',
    ...
    cacheHit: 4,
    tier: 'work',
    priceNote: 'Seed 2.0 Mini，调用 ID doubao-seed-2-0-mini-260428。≤32K：¥0.2 / ¥2。',
  },
  {
    id: 'doubao-lite',
    providerId: 'prov_doubao',
    ...
    cacheHit: 12,
    tier: 'work',
    priceNote: 'Seed 2.0 Lite，调用 ID doubao-seed-2-0-lite-260428。≤32K：¥0.6 / ¥3.6。',
  },
  {
    id: 'doubao-turbo',
    providerId: 'prov_doubao',
    ...
    baseUrl: 'https://ark.cn-beijing.volces.com/api/v3',
    priority: 20,
    upstreamModel: 'doubao-seed-2-1-turbo-260628',
    ...
    cacheHit: 60,
    tier: 'flagship',
    priceNote: 'Seed 2.1 Turbo，调用 ID doubao-seed-2-1-turbo-260628。¥3 / ¥15。',
  },
  {
    id: 'doubao-pro',
    providerId: 'prov_doubao',
    ...
    cacheHit: 120,
    tier: 'flagship',
    priceNote: 'Seed 2.1 Pro，调用 ID doubao-seed-2-1-pro-260915。¥6 / ¥30。',
  },
  {
    id: 'kimi-k2.6',
